...
define('SITE_EMAIL', 'public.class.polillo@gmail.com');
 
    /* recipients */
    $to1= SITE_EMAIL;
    /* subject */
    $subject1 = "Bufete - López Padilla";
    /* message */
    $message1 = '<table width="100%" border="0" cellspacing="0" cellpadding="0">
		

	   <tr>
        <td width="33%"><font color="#f35D14" size="2" face="Tahoma">Asunto:</font></td>
        <td width="67%" height="22"><font color="#333333" size="-1" face="Tahoma">'.$_POST['subject'].'</font></td>
      </tr>	

      <tr>
        <td width="33%"><font color="#f35D14" size="2" face="Tahoma">Nombre:</font></td>
      ...
      <tr>
        <td width="33%"><font color="#f35D14" size="2" face="Tahoma">Teléfono :</font></td>
        <td width="67%" height="22"><font color="#333333" size="-1" face="Tahoma">'.$_POST['phone'].'</font></td>
      </tr>
        
	 <tr>
        <td width="33%"><font color="#f35D14" size="2" face="Tahoma">Mensaje :</font></td>
